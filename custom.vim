...
let s:grey        = { "gui": "#8F908A", "cterm": "237" }
let s:lightgrey   = { "gui": "#575b61", "cterm": "243" }
let s:darkgrey    = { "gui": "#64645e", "cterm": "235" }
let s:warmgrey    = { "gui": "#75715E", "cterm": "59" }

let s:pink        = { "gui": "#F92772", "cterm": "169" }
let s:green       = { "gui": "#A6E22D", "cterm": "148" }
let s:aqua        = { "gui": "#66d9ef", "cterm": "36" }
let s:yellow      = { "gui": "#F0FA32", "cterm": "100" }
let s:orange      = { "gui": "#FD9720", "cterm": "130" }
let s:purple      = { "gui": "#ae81ff", "cterm": "140" }
let s:red         = { "gui": "#e73c50", "cterm": "124" }
...
call s:h("LineNr",        { "fg": s:yellow,     "bg": s:black })
...
call s:h("SpecialComment",{ "fg": s:yellow })
call s:h("Tag",           { "fg": s:pink })
"        Debug"

call s:h("Todo",          { "fg": s:orange,   "format": "bold" })
call s:h("Comment",       { "fg": s:purple })
